import 'package:ChemNOR_it/pages/home.dart';
...
class _MoleculeSearchScreenState extends State<MoleculeSearchScreen> {
  ...
  final ChemNOR _chemPubService = ChemPubService('YOUR_CHEMPUB_API_KEY');
  ...
  Future<void> _searchMolecules() async {
    ...
    try {
      ...
      final results = await _chemPubService.searchCompounds(
        ...
        query: interpretedQuery.searchTerms[1],
        maxResults: 10,
      );
                    ...
                    return ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          if (molecule.bioactivity != null) Text('Bioactivity: ${molecule.bioactivity}'),
                        ],
                      ),
                    );
                  },
